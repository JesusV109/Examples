...
public class MyLinkedList<E> implements MyList<E> {
	  ...
	  public int size() {
	    return size;
		 ...
		 System.out.println("Time taken to add one element to MyLinkedList: " + totalTime + " nanoseconds");
		 ...
		 endTime = System.nanoTime();
		 totalTime = endTime - startTime;
		 System.out.println("Time taken to add first element to MyLinkedList: " + totalTime + " nanoseconds");
		 ...
		 endTime = System.nanoTime();
		    totalTime = endTime - startTime;
		    System.out.println("Time taken to removeLast element in MyLinkedList: " + totalTime + " nanoseconds");
		 }
	}